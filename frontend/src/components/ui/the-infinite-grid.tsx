...
export const InfiniteGrid = ({ children, className }: { children?: React.ReactNode, className?: string }) => {
  ...
  return (
    <div
      ...
      className={cn(
        "relative w-full flex flex-col items-center overflow-hidden bg-white",
        className
      )}
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <div className="absolute left-[-10%] bottom-[-20%] w-[40%] h-[40%] rounded-full bg-cyan-500/10 blur-[120px]" />
      </div>
